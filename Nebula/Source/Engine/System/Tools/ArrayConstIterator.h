/**
A const forward iterator for a standard array.
...
#ifndef ARRAY_CONST_ITERATOR_H
#define ARRAY_CONST_ITERATOR_H

template <class ElementType>
class ArrayConstIterator
{
	private:
		typedef ArrayConstIterator<ElementType> Iter;
	...
	public:
		...
		ArrayConstIterator(ElementType* pElement)
		{
			m_pElement = pElement;
		}
		...
		ArrayConstIterator(const Iter& other)
		{
