/**
A const forward iterator for a cyclic array.
...
#ifndef CYCLIC_ARRAY_CONST_ITERATOR_H
#define CYCLIC_ARRAY_CONST_ITERATOR_H

#include "Engine/System/Tools/Pair.h"

template <class ElementType>
class CyclicArrayConstIterator
{
	private:
		typedef CyclicArrayConstIterator<ElementType> Iter;
	...
	public:
		...
		CyclicArrayConstIterator(const Pair<ElementType, bool>* pElement)
		{
			m_pElement = pElement;
		}
		...
		CyclicArrayConstIterator(const Iter& other)
		{
