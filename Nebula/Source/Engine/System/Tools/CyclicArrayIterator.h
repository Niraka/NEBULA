/**
A forward iterator for a cyclic array.
...
#ifndef CYCLIC_ARRAY_ITERATOR_H
#define CYCLIC_ARRAY_ITERATOR_H
...
{
	private:
		typedef CyclicArrayIterator<ElementType> Iter;
	...
	public:
		...
		CyclicArrayIterator(Pair<ElementType, bool>* pElement)
		{
			m_pElement = pElement;
		}
		...
		CyclicArrayIterator(const Iter& other)
		{
