/**
A forward iterator for a cyclic vector.
...
#ifndef CYCLIC_VECTOR_ITERATOR_H
#define CYCLIC_VECTOR_ITERATOR_H

template <class ElementType>
class CyclicVectorIterator
{
	private:
		typedef CyclicVectorIterator<ElementType> Iter;
	...
	public:
		...
		CyclicVectorIterator(ElementType* pElement)
		{
			m_pElement = pElement;
		}
		...
		CyclicVectorIterator(const Iter& other)
		{
