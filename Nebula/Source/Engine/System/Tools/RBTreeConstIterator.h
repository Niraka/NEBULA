...
#ifndef RB_TREE_CONST_ITERATOR_H
#define RB_TREE_CONST_ITERATOR_H

template <class ElementType>
class RBTreeConstIterator
{
	private:
		typedef RBTreeConstIterator<ElementType> Iter;
	...
	public:
		...
		RBTreeConstIterator(RBTreeNode<ElementType>* pNode)
		{
			m_pNode = pNode;
		}
		...
		RBTreeConstIterator(const Iter& other)
		{
