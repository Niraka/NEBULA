/**
A forward iterator for a tracked array.
...
#ifndef TRACKED_ARRAY_ITERATOR_H
#define TRACKED_ARRAY_ITERATOR_H

template <class ElementType>
class TrackedArrayIterator
{
	private:
		typedef TrackedArrayIterator<ElementType> Iter;
	...
	public:
		...
		TrackedArrayIterator(Pair<ElementType, bool>* pElement)
		{
			m_pElement = pElement;
		}
		...
		TrackedArrayIterator(const Iter& other)
		{
